...
public class Blacksmith {
    ...
    public void printPageOne() {
        ...
        System.out.println("A collection of bones forged into a power armor and weapon set with the help of a mage's scroll. ");
    ...
    public void printPageTwo() {
        System.out.println("The Hide Set \uD83D\uDC17");
        System.out.println("A strong, sturdy set of armor made from enchanted animal hide. Nothing too special.");
        System.out.println("Crafting requirements: ");
    ...
    public void printPageThree() {
        ...
        System.out.println("A powerful set that grants you strength from all the elements.");
        System.out.println("Crafting requirements: ");
    ...
    public void printPageFour() {
        ...
        System.out.println("An incredibly difficult set to pierce through. It's put together using crystals dropped from powerful mobs.");
        System.out.println("Crafting requirements: ");
    ...
    public void printPageFive() {
        ...
        System.out.println("An extremely powerful set that grants you all the powers of the Umbral Knight. One must get through the deepest, darkest layer to obtain this set");
        System.out.println("Crafting requirements: ");
    ...
    public void printPageSix() {
        ...
        System.out.println("The quickest set achievable. Extremely difficult for enemies to hit you. Obtained by defeating the quickest mobs in the deepest layer");
        System.out.println("Crafting requirements: ");
    ...
    public void printPageSeven() {
        ...
        System.out.println("The most durable set achievable. Grants you vasts amount of health and armor.");
        System.out.println("Crafting requirements: ");
